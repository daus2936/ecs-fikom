...
// Halaman utama
// =====================================================
export default function GrossProfitBefore2025() {
  ...
  const calculate = async (e) => {
    ...
    try {
      const endpoint = mode === 'period'
        ? '/gross-profit-before-2025/calculate'
        : '/gross-profit-before-2025/calculate-by-invoice';
  ...
  return (
    <div className="p-8 max-w-7xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900">Gross Profit Before 2025</h1>
        <p className="text-slate-500 mt-1 text-sm">
          Kalkulasi Gross Profit Before 2025 = Total Invoice Cover − Total Expense, diambil dari data Invoice Cover Before 2025 dan Expenses Before 2025.
        </p>
      </div>
        ...
        <div className="space-y-5">
          ...
          <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
            ...
            <button type="submit" disabled={!canCalculate || loading} className="btn-primary">
              {loading ? 'Menghitung…' : 'Hitung Gross Profit Before 2025'}
            </button>
          </div>
        </div>
      </form>
...
function ResultView({ data }) {
  ...
  return (
    <div className="space-y-6">
      {/* Summary cards */}
      <div>
        <h2 className="text-sm uppercase tracking-wide text-slate-500 font-medium mb-3">
          Ringkasan {subtitle}
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          />
          <SummaryCard
            label="Gross Profit Before 2025"
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
        ...
        <div className="text-sm space-y-1 font-mono">
          ...
          <div className="flex items-baseline gap-2 pt-1 border-t border-slate-300">
            <span className="text-slate-500 w-44">Gross Profit Before 2025</span>
            <span>=</span>
