...
// halaman "DB".
// Sama seperti DB Before 2025 (versi live), dengan:
...
export function downloadDBTemplate() {
  ...
  XLSX.writeFile(wb, 'template-import-db.xlsx');
}

// Parse uploaded file → { rows } siap kirim ke backend
export async function parseDBExcel(file) {
